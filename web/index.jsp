...
<!-- image -->
<h1><a href="${pageContext.request.contextPath}/RecursiveAdd.jsp">Triangular Number Calculator (Using Recursive
    Addition!)</a></h1>
<!-- These are the hyperlinks, and they are on the index page. The user will click a hyperlink to call a specific servlet. -->
<h1><a href="${pageContext.request.contextPath}/RecursiveMult.jsp">Factorial Calculator (Using Recursive
    Multiplication!)</a></h1>
